...
case "$VERSION" in *-alpha.4) VERSION=${VERSION%-alpha.4}~alpha.4;; *-alpha.3) VERSION=${VERSION%-alpha.3}~alpha.3;; *-alpha.2) VERSION=${VERSION%-alpha.2}~alpha.2;; *-alpha.1) VERSION=${VERSION%-alpha.1}~alpha.1;; *-alpha) VERSION=${VERSION%-alpha}~alpha;; esac
